...
String formatCurrency(int value) {
  final format = NumberFormat.currency(
    ...
    decimalDigits: 0, // Number of decimal digits (set to 0 for INR)
    locale: 'in_IND', // India locale for formatting
  );

  return '${format.format(value)} INR'; // Append ' inr' to the formatted value
}
